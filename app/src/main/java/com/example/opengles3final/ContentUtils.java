...
public class ContentUtils {
    ...
    public static void addUri(String name, Uri uri) {
        ...
        Log.d("ContentUtils", "Added URI to documentsProvided: " + name + " -> " + uri.toString());
    ...
    public static Uri getUri(String name) {
        ...
        if (uri == null) {
            Log.d("ContentUtils", "URI not found in documentsProvided for: " + name);
        } else {
            Log.d("ContentUtils", "Retrieved URI from documentsProvided for: " + name + " -> " + uri.toString());
        }
