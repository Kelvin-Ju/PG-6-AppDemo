...
public class MainActivity extends AppCompatActivity {
    ...
    private void openButtonFragmentWithSubjectID(String subjectID) {
        ...
        transaction.replace(R.id.fragment_container, buttonFragment); // Ensure this is your container ID
    ...
    private void openCameraFragment() {
        ...
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.fragment_container, cameraFragment); // Ensure you have a FrameLayout or similar in your activity_main.xml as the container
        transaction.addToBackStack(null);
        transaction.commit();
    ...
    private void openButtonFragment() {
        ButtonFragment buttonFragment = new ButtonFragment();
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.fragment_container, buttonFragment); // Use the correct container ID where you want to place your fragment
